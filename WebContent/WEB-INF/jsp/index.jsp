...
<%@ page import="manage.action.ManageAction_gbt" %>
...
<body scroll="no" style="height: 80px">
	<div id="layout">
		<div id="header">
			<div class="headerNav">			
				<div style="font-size: 26px;font-weight: bold;color: #A9D0F5;padding-left:25px;height: 40px;padding-top: 13px;">学生考勤管理系统</div>
				<ul class="nav">
					<li><a href="javascript:void(0);"><%=ManageAction_gbt.time2%>您好,${username}</a></li>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p><h1 style="font-size: 20px;text-align: center;color:#008080;padding-top: 17px">您好，${username}。欢迎使用学生考勤管理系统！</h1></p>
						</div>
						
						<div class="pageFormContent" layoutH="80">
							<c:if test="${role=='role4'}">
						    <p><h1 style="font-size: 20px;color:#FF00FF">${kaoqinlogtishi}</h1></p>
						</c:if>
						</div>
					</div>
